...
// source: icplaza/validator-dao/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "icplaza.validatordao.v1.GenesisState")
}

func init() {
	proto.RegisterFile("icplaza/validator-dao/v1/genesis.proto", fileDescriptor_a967998b42aaa103)
}
