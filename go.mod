...
replace (
	...
	github.com/cosmos/cosmos-sdk => ../cosmos-sdk-icplaza@v0.46.9-ledger
	github.com/cosmos/ibc-go/v6 => ../ibc-go@v6.1.0
	github.com/evmos/ethermint => ../ethermint@v0.21.0
	...
	github.com/tendermint/tendermint => ../tendermint@v0.34.26
)
